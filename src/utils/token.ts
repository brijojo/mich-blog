...
const RefrenshTokenKey = 'saber-refresh-toekn';
...
export function getRefreshToken() {
    return Cookies.get(RefrenshTokenKey);
}

export function setRefreshToken(token: string) {
    return Cookies.set(RefrenshTokenKey, token);
}
...
export function removeRefreshToken() {
    return Cookies.remove(RefrenshTokenKey);
}
